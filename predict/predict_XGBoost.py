...
if SAVE_RESULTS:
    ...
    draw_fig(Actual=predictions_df["Actual"], Predicted=predictions_df["Predicted"], title="XGBoost Predictions", save_path=f'{folder_path}/predictions.png', is_show_fig=False)