...
class CNN1D(nn.Module, BaseModel):
    """
    ...
    def forward(self, x):
        """
        Forward pass for the OneDCNN model.
        
        Args:
            x (torch.Tensor): Input tensor of shape [batch_size, window_size, 1].
